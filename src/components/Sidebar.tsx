  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-white border-r border-slate-200 flex flex-col z-20">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-100">
        ...
        <div>
          <p className="text-sm font-semibold text-slate-900 leading-none">ImmoSuite</p>
          <p className="text-xs text-slate-400 mt-0.5">Agent Platform</p>
        </div>
      </div>
      ...
      <div className="px-5 py-4 border-t border-slate-100">
        <p className="text-xs text-slate-400">v0.1.0 — Batipart Tools</p>
      </div>
    </aside>
  );
}
